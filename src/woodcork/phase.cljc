(ns woodcork.phase
  "Phase 0->3 staged rollout for the wood/cork/straw-products-shop
  ...
  consequence (a cutting/molding/weaving-line maintenance window means
  production downtime, and the equipment ends up actually touched); it
  is always a human plant supervisor's call. `woodcork.governor`'s
  `cutting-molding-line-finalize-blocked-violations` HARD-blocks
...
(defn verdict->disposition
  "Map a Wood, Cork & Straw Products Shop Plant Operations Governor
  verdict to a base disposition before the phase gate."
  [verdict]
