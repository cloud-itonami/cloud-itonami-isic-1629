# Operator Quickstart — Manufacture of other products of wood; manufacture of articles of cork, straw and plaiting materials

Shortest path from clone to a verified local dry-run for **ISIC 1629** (`cloud-itonami-isic-1629`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1629.git
cd cloud-itonami-isic-1629
```
...
- Blueprint governor key: `wood-cork-straw-products-shop-plant-operations-governor`
- Likely source path: `woodcork.governor.cljc`
